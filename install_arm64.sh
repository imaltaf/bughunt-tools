...
wget https://go.dev/dl/$goversion.linux-arm64.tar.gz -q 2> /dev/null &> /dev/null
rm -rf /usr/local/go && tar -C /usr/local -xzf $goversion.linux-arm64.tar.gz 2> /dev/null &> /dev/null
